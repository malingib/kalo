...
/** Base URL for the running Kalo instance */
...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://kalo.local";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Kalo";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@kalo.local";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Kalo";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Kalo";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Kalo";
...
export const JOIN_COMMUNITY = "https://github.com/malingib/kalo/discussions";
export const POWERED_BY_URL = WEBAPP_URL;
export const DOCS_URL = `${WEBAPP_URL}/docs`;
export const DEVELOPER_DOCS = `${WEBAPP_URL}/docs`;
...
export const KALO_PRIVATE_API_ROUTE = process.env.KALO_PRIVATE_API_ROUTE || "";
