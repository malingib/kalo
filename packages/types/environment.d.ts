declare namespace NodeJS {
  interface ProcessEnv {
    ...
    readonly NEXT_PUBLIC_APP_NAME: string | "Kalo";
    readonly NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS: string | "support@example.com";
    readonly NEXT_PUBLIC_COMPANY_NAME: string | "Kalo";
