...
export const oAuthRouter = router({
  ...
  // Named createOAuthClient (not createClient): the router key `createClient`
  // collides with tRPC's built-in proxy method of the same name, which breaks
  // the client types for the ENTIRE app router.
  createOAuthClient: authedAdminProcedure.input(ZCreateClientInputSchema).mutation(async ({ ctx, input }) => {
