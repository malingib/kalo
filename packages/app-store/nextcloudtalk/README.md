...
6. Under "Add client" give your client a name, e.g. "Kalo".
7. Set the Redirection URI as `<Kalo URL>/api/integrations/nextcloudtalk/callback` replacing [Kalo](https://cal.com) URL with the URI at which your application runs.
8. Click "Add".
