...
3. Set the Redirect URL for OAuth `<Kalo URL>/api/integrations/zoho-bigin/callback` replacing Kalo URL with the URI at which your application runs.
...
7. You're good to go. Now you can easily add Zoho Bigin from the [Kalo](https://cal.com) app store.
