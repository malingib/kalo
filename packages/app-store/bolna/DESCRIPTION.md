...
### Function calling
Simply add functions to book calendar  appointments([cal.com](https://github.com/malingib/kalo)), transfer calls to human agents in real time, or even create your own function calls
