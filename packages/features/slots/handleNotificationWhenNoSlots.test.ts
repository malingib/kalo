...
import * as CalcomEmails from "@kalo/emails/organization-email-service";
import { getNoSlotsNotificationService } from "@kalo/features/di/containers/NoSlotsNotification";
import { describe, expect, it, vi } from "vitest";

vi.mock("@kalo/features/redis/RedisService", () => {
...
vi.mock("@kalo/features/flags/features.repository", () => ({
...
vi.mock("@kalo/emails/organization-email-service", () => ({
