...
import type { EventType, User, Webhook } from "@kalo/prisma/client";
...
vi.mock("@kalo/features/webhooks/lib/tasker/WebhookTasker", () => ({
...
const { getWebhookProducer } = await import("@kalo/features/di/webhooks/containers/webhook");
