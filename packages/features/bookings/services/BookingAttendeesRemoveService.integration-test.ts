...
vi.mock("@kalo/features/bookings/lib/EventManager", () => ({
...
vi.mock("@kalo/emails/templates/attendee-cancelled-email", () => ({
...
vi.mock("@kalo/trpc/server/routers/viewer/bookings/addGuests.handler", async (importOriginal) => {
