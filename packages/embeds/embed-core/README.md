...
You can also see various example usages [here](https://github.com/calcom/kalo/blob/main/packages/embeds/embed-core/index.html)
...
- Branding
  ...
  - Powered by Kalo and 'Try it for free'. Should they be shown only for FREE account.
