...
import type { GlobalCal, GlobalCalWithoutNs, Queue } from "@kalo/embed-core";
// FIXME: embed-snippet is a published package and shouldn't import from @kalo/types which is unpublished
...
import type { Optional } from "@kalo/types/utils";
