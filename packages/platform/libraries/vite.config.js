...
export default defineConfig({
    ...
    rollupOptions: {
      ...
      output: {
        globals: {
          ...
          "@kalo/prisma/client": "@kalo/prisma/client",
        },
      },
    },
  },
  ...
  resolve: {
    ...
    alias: {
      ...
      "@kalo/lib": path.resolve(__dirname, "../../lib"),
      "@kalo/trpc": resolve("../../trpc"),
      "lru-cache": resolve("../../../node_modules/lru-cache/dist/cjs/index.js"),
      "@kalo/prisma/client/runtime/library": resolve("../../prisma/client/runtime/library"),
      "@kalo/prisma/client": resolve("../../prisma/client"),
