import type { EventAdvancedBaseProps } from "@kalo/web/modules/event-types/components/tabs/advanced/EventAdvancedTab";
import { EventAdvancedTab } from "@kalo/web/modules/event-types/components/tabs/advanced/EventAdvancedTab";
