...
```
<Kalo URL>/api/integrations/hubspot/callback
```

Replace `<Kalo URL>` with the URL where your application is hosted.
...
10. **Complete HubSpot Integration** - You're all set! Any booking in Kalo will now be created as a meeting in HubSpot for your contacts.
