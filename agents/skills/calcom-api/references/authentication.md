...
Detailed documentation for authentication methods in the Kalo API v2.

## Authentication Methods

Kalo API v2 supports two authentication methods:
...
All Kalo API keys are prefixed with `cal_`:
...
5. **Monitor API usage**: Check your Kalo dashboard for unusual activity
