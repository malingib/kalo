...
**Rules:**
1. No files in `packages/lib` import from `@kalo/app-store` or `../app-store/**`
2. No files in `packages/lib` import from `@kalo/features` or `../features/**`
3. No files in `packages/lib` import from `@kalo/trpc` or `../trpc/**`
...
import { getBooking } from "@kalo/features/bookings";
import { EventRepository } from "@kalo/features/events/repositories";

// Bad - lib importing from app-store
import { googleCalendarHandler } from "@kalo/app-store/googlecalendar";
...
**Rules:**
6. No files in `packages/app-store` import from `@kalo/features` or `../features/**`
7. No files in `packages/app-store` import from `@kalo/trpc` or `../trpc/**`

**Incorrect:**

```typescript
// Bad - app-store importing from features
import { BookingService } from "@kalo/features/bookings/services";

// Bad - app-store importing from trpc
import { publicProcedure } from "@kalo/trpc/server/trpc";
```
...
**Rules:**
8. No files in `packages/features` import from `@kalo/trpc` or `../trpc/**`
9. No files in `packages/features` import from `@kalo/web` or `@kalo/web/**`
...
import { getServerSession } from "@kalo/web/lib/auth";
...
**Rules:**
12. No files in `packages/testing` import from `@kalo/web` or `@kalo/web/**`
13. No files in `packages/testing` import from `@kalo/features` or `@kalo/features/**`
...
import { WebComponent } from "@kalo/web/components";
import { BookingService } from "@kalo/features/bookings";
```
...
**Rules:**
16. No files in `packages/platform/atoms` import from `@kalo/trpc` or `@kalo/trpc/**`
17. No files in `packages/platform/atoms` import from `../../trpc` or `../../trpc/**`
18. No files in `packages/platform/atoms` import from `@kalo/web`
...
import { WebComponent } from "@kalo/web";
```
...
import type { Booking } from "@kalo/features/bookings/types";
```
